...
import copyDialog from './copyDialog.png'
...
export const CopyAlert = ({ isOpen, variant = 'warning' }: Props) => {
      ...
      <div className={classes}>
        <div className="p-4">
          <p className="text-sm text-center font-medium text-gray-900">
            <img src={copyDialog} width="125" height="34" alt="Copied to clipboard" />
          </p>
        </div>
      </div>
    </Transition>
